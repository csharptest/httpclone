...
namespace CSharpTest.Net.HttpClone.Publishing
{
    class SaveContent
    {
        ...
        public SaveContent(SiteCollector collector, string path, Action<Action> queue, HttpRequestUtil request)
        {
        ...
        public void DoWork()
        {
            _collector.SetContents(_path, _request.StatusCode, _request.ContentType, _request.ETag, _request.LastModified, _request.Content);
        }
    }
}
