...
namespace CSharpTest.Net.HttpClone.Publishing
{
    class SaveNotModified
    {
        ...
        public SaveNotModified(SiteCollector collector, string path, Action<Action> queue, HttpRequestUtil request)
        {
        ...
        public void DoWork()
        {
            _collector.SetNotModified(_path);
        }
    }
}
